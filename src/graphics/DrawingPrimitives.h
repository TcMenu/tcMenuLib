...
#define RGB_COL_BLACK RGB(0, 0, 0)
#define RGB_COL_WHITE RGB(255, 255, 255)
#define RGB_COL_RED RGB(255, 0, 0)
#define RGB_COL_GREEN RGB(0, 255, 0)
#define RGB_COL_BLUE RGB(0, 0, 255)
#define RGB_COL_YELLOW RGB(255, 255, 0)
#define RGB_COL_MAGENTA RGB(255, 0, 255)
#define RGB_COL_CYAN RGB(0, 255, 255)
#define RGB_COL_ORANGE RGB(255, 128, 0)
#define RGB_COL_PURPLE RGB(128, 0, 128)
#define RGB_COL_BROWN RGB(128, 64, 0)
#define RGB_COL_LIGHT_GRAY RGB(192, 192, 192)
#define RGB_COL_DARK_GRAY RGB(64, 64, 64)
#define RGB_COL_LIGHT_RED RGB(255, 128, 128)
#define RGB_COL_LIGHT_GREEN RGB(128, 255, 128)
#define RGB_COL_LIGHT_BLUE RGB(128, 128, 255)
#define RGB_COL_SEL_BLUE RGB(123, 196, 206)
#define RGB_COL_LIGHT_YELLOW RGB(255, 255, 128)
