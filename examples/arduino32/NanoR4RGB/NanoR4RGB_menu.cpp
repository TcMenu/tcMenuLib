...
// Generated for Arduino 32bit ARM by TcMenu 5.0.0-SNAPSHOT on 2026-09-14T16:18:09.828278Z.
...
const  ConnectorLocalInfo applicationInfo = { "NanoR4 RGB", "aab5df00-3943-48ad-8edf-0112f7be8925" };

Adafruit_SSD1351 display(128, 128, &SPI, 10, 9, 8);
AdafruitDrawable displayDrawable(&display, 40);
...
void setupMenu() {
    ...
    // Code generated by plugins and new operators.
        ...
        encBuild.withEncoderPins(A1, A2)
           .interruptOnBothPins()
        ...
        menuMgr.initWithoutInput(&renderer, &getMenuCount());
        applyTheme(renderer);
}
