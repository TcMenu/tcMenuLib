...
// Generated for STM32Duino by TcMenu 5.0.0-SNAPSHOT on 2026-09-15T17:15:55.619967Z.
...
void setupMenu() {
    ...
    // Code generated by plugins and new operators.
        ...
        encBuild.withEncoderPins(PC10, PC8)
           .interruptOnBothPins()
           .withCallback([](const int value) {menuMgr.valueChanged(value); })
           .withEncoderType(FULL_CYCLE)
           .build();
        switches.onRelease(PC9, [](pinid_t /*key*/, const bool held) { menuMgr.onMenuSelect(held); });
        menuMgr.initWithoutInput(&renderer, &getMenu33());
