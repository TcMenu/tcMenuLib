...
FloatMenuItem menuAnalogReadingsInA0(&minfoAnalogReadingsInA0, 0.0, &menuAnalogReadingsOutputPWM);
...
FloatMenuItem menuAccelerometerAccelZ(&minfoAccelerometerAccelZ, 0.0, NULL);
const FloatMenuInfo minfoAccelerometerAccelY = { "AccelY", 9, 0xffff, 2, NO_CALLBACK };
FloatMenuItem menuAccelerometerAccelY(&minfoAccelerometerAccelY, 0.0, &menuAccelerometerAccelZ);
const FloatMenuInfo minfoAccelerometerAccelX = { "AccelX", 8, 0xffff, 2, NO_CALLBACK };
FloatMenuItem menuAccelerometerAccelX(&minfoAccelerometerAccelX, 0.0, &menuAccelerometerAccelY);
const FloatMenuInfo minfoAccelerometerMagZ = { "MagZ", 7, 0xffff, 2, NO_CALLBACK };
FloatMenuItem menuAccelerometerMagZ(&minfoAccelerometerMagZ, 0.0, &menuAccelerometerAccelX);
const FloatMenuInfo minfoAccelerometerMagY = { "MagY", 6, 0xffff, 2, NO_CALLBACK };
FloatMenuItem menuAccelerometerMagY(&minfoAccelerometerMagY, 0.0, &menuAccelerometerMagZ);
const FloatMenuInfo minfoAccelerometerMagX = { "MagX", 5, 0xffff, 2, NO_CALLBACK };
FloatMenuItem menuAccelerometerMagX(&minfoAccelerometerMagX, 0.0, &menuAccelerometerMagY);
