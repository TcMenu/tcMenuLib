...
// Generated for Arduino 32bit ARM by TcMenu 4.5.9-SNAPSHOT on 2026-07-11T08:15:09.047703Z.
...
const BooleanMenuInfo minfoSettingsYesNo = { getTcLocaleString(TC_I18N_MENU_8_NAME), 8, 0xffff, 1, NO_CALLBACK, NAMING_YES_NO };
BooleanMenuItem menuSettingsYesNo(&minfoSettingsYesNo, false, &menuSettingsCheckBox, INFO_LOCATION_PGM);
const AnyMenuInfo minfoSettingsRGB = { getTcLocaleString(TC_I18N_MENU_7_NAME), 7, 0xffff, 0, NO_CALLBACK };
...
const SubMenuInfo minfoSettings = { getTcLocaleString(TC_I18N_MENU_5_NAME), 5, 0xffff, 0, NO_CALLBACK };
...
const char enumStrEnum_0[] = getTcLocaleString(TC_I18N_MENU_3_ENUM_0);
const char enumStrEnum_1[] = getTcLocaleString(TC_I18N_MENU_3_ENUM_1);
const char enumStrEnum_2[] = getTcLocaleString(TC_I18N_MENU_3_ENUM_2);
const char* const enumStrEnum[]  = { enumStrEnum_0, enumStrEnum_1, enumStrEnum_2 };
const EnumMenuInfo minfoEnum = { getTcLocaleString(TC_I18N_MENU_3_NAME), 3, 0xffff, 2, NO_CALLBACK, enumStrEnum };
EnumMenuItem menuEnum(&minfoEnum, 0, &menuPower, INFO_LOCATION_PGM);
const FloatMenuInfo minfoFloat = { getTcLocaleString(TC_I18N_MENU_2_NAME), 2, 0xffff, 1, NO_CALLBACK };
FloatMenuItem menuFloat(&minfoFloat, 0.0, &menuEnum, INFO_LOCATION_PGM);
const AnalogMenuInfo minfoAnalog = { getTcLocaleString(TC_I18N_MENU_1_NAME), 1, 0xffff, 1000, NO_CALLBACK, 0, 10, getTcLocaleString(TC_I18N_MENU_1_UNIT) };
