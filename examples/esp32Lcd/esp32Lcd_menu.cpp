...
const char pgmAuthMgrPassword[] PROGMEM = "123";
ReadOnlyAuthenticationManager authManager(authMgrAllowedRemotes, 1, pgmAuthMgrPassword);
LiquidCrystal lcd(0, 1, 2, 4, 5, 6, 7);
LiquidCrystalRenderer renderer(lcd, 20, 4);

// Global Menu Item declarations
const PROGMEM char pgmStrGridAuthenticatorText[] = { "Authenticator" };
EepromAuthenticationInfoMenuItem menuGridAuthenticator(pgmStrGridAuthenticatorText, NO_CALLBACK, 13, NULL);
RENDERING_CALLBACK_NAME_INVOKE(fnGridNewChoiceItemRtCall, enumItemRenderFn, "New Choice Item", -1, NO_CALLBACK)
ScrollChoiceMenuItem menuGridNewChoiceItem(12, fnGridNewChoiceItemRtCall, 0, 122, 11, 4, &menuGridAuthenticator);
